                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                        <div class="section-heading">
                            <h2 class="sec__title text-white font-size-40 mb-0">{{ __('Add post listing') }}</h2>
                        </div>
                        {{ Breadcrumbs::view('partials/breadcrumbs-list' , 'add-post') }}
                ...
                <div class="col-lg-10 mx-auto">
                    @guest
                        <div class="alert alert-info font-size-15 text-color" role="alert">
                            ...
                            <a href="#" class="alert-link text-color-2" data-toggle="modal" data-target="#loginModal">
                                log in</a>
                            or <a href="#" class="alert-link text-color-2" data-toggle="modal"
                                  data-target="#signUpModal">create</a> an account to add a pet
                        </div><!-- alert -->
                    @elseauth

                        <div class="alert alert-info font-size-15 text-color" role="alert">
                            <p>{{ __('Your tariff plan') }}: {{ auth()->user()->plan->title }}
                                <br>
                                {{ __('Available limit') }}: {{ auth()->user()->plan->feature->limit }} {{ __('count') }}
                                <br>
                                {{ __('Days Long') }}: {{ auth()->user()->plan->feature->days_long }}
                            </p>
                        </div><!-- alert -->
                        ...
                        <div>
                                ...
                                <div class="block-card-body">
                                    <div class="form-box row MultiFile-intercepted">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <x-home.ui.textarea title="Description (max 2000 character)" wire:model.defer="pet.description" rows="1" placeholder="Enter Description "/>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="file-upload-wrap file-upload-wrap-2" wire:ignore>
                                                <input type="file"
                                                       name="files[]"
                            ...
                            <div class="btn-box">
                                <button type="button" wire:loading.attr="disabled" class="theme-btn gradient-btn border-0" wire:click="addPet">
                                    {{ __('Create Post') }}
                                </button>
                            </div>
                        </div>
