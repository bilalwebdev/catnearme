...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Mostafaznv\Larupload\LaruploadServiceProvider::registerMacros()
         * @param string $name
         * @param \Mostafaznv\Larupload\Enums\LaruploadMode $mode
         * @static 
         */ 
        public static function upload($name, $mode = Mostafaznv\Larupload\Enums\LaruploadMode::HEAVY)
        {
                        return \Illuminate\Database\Schema\Blueprint::upload($name, $mode);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function dropUpload($name, $mode = Mostafaznv\Larupload\Enums\LaruploadMode::HEAVY)
        {
                        return \Illuminate\Database\Schema\Blueprint::dropUpload($name, $mode);
        }
